        ...
        <div className="text-center">
          <h1 className="text-3xl sm:text-5xl lg:text-7xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight">
            ...
            <span className="block bg-gradient-to-r from-purple-600 via-blue-600 to-purple-800 bg-clip-text text-transparent">
              Rental Home in Kenya
            </span>
          </h1>
          <p className="text-base sm:text-xl lg:text-2xl text-gray-600 mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed px-4">
            Discover amazing rental properties across Kenya. From modern apartments in Nairobi to spacious houses in Karen, 
            find your next home with verified landlords and transparent pricing.
          </p>
                ...
                <div className="block sm:hidden space-y-3">
                  <div className="relative">
                    ...
                    <Input 
                      ...
                      aria-label="Search rental properties in Kenya"
                    />
                  </div>
                  <div className="relative">
                    <MapPin className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400" />
                    <Input 
                      placeholder="Nairobi, Kilimani, Karen, Westlands..."
                      className="h-12 pl-10 text-base border-slate-200 focus:border-purple-500 focus:ring-purple-500"
                      aria-label="Location in Kenya"
                    />
                  </div>
                  ...
                  <div className="flex-1">
                    <div className="relative">
                      ...
                      <Input 
                        ...
                        className="h-12 lg:h-14 pl-12 text-base lg:text-lg border-slate-200 focus:border-purple-500 focus:ring-purple-500"
                        aria-label="Enter location in Kenya"
                      />
                    </div>
                  </div>
                  <Button 
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
            <Button 
              ...
              aria-label="Browse all rental properties in Kenya"
            >
              Browse Properties
            ...
            <Button 
              ...
              aria-label="Sign up to access all property listings"
            >
              View All Properties
            </Button>
          </div>
